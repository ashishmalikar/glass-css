...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("./time-picker"));
	else if(typeof define === 'function' && define.amd)
		define(["./time-picker"], factory);
	else if(typeof exports === 'object')
		exports["DatePicker"] = factory(require("./time-picker"));
	else
  ...
  getSelector: function(elem) {
    ...
    if (elem.id) {
      ...
      if(elem.tagName == 'svg') {
        ...
        selector = '.' + parent?.className?.split(' ')[0];
      } else {
...
var DatePicker = defineClass(
  /** @lends DatePicker.prototype */ {
     ...
     * @see {@link https://nhn.github.io/tui.time-picker/latest ./time-picker}
     * @example
...
function bindEvent(element, type, handler, context) {
  ...
  if ('addEventListener' in element) {
    ...
    console.log('adding event for: ', element.tagName)

    element.addEventListener(type, eventHandler);
  } else if ('attachEvent' in element) {
    console.log('attaching event for: ', element.tagName)
...
module.exports = function(context) {
  var source =
    ...
    '      <div style="display: block;"><em class="tui-calendar-title {{titleClass}}">{{title}}</em></div>' +
    '    <div class="tui-calendar-title-actions">' +
    '      <button class="tui-calendar-btn tui-calendar-btn-prev-year">' +
    '        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-left" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">'+
    '            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>'+
    '  <polyline points="15 6 9 12 15 18" stroke="#007aff"/>'+
    '</svg></button>' +
    '        <button class="tui-calendar-btn tui-calendar-btn-prev-month">'+
    '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-left" width="24" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">'+
    '  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>'+
    '  <polyline points="15 6 9 12 15 18" stroke="#007aff"/>'+
    '</svg></button>' +
    '        <button class="tui-calendar-btn tui-calendar-btn-next-month">'+
    '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-chevron-right" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">'+
    '   <path stroke="none" d="M0 0h24v24H0z" fill="none"/>'+
    '   <polyline points="9 6 15 12 9 18" stroke="#007aff"/>'+
    '      </svg></button>' +
